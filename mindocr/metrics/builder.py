from . import cls_metrics, det_metrics, rec_metrics, table_metrics
...
supported_metrics = det_metrics.__all__ + rec_metrics.__all__ + cls_metrics.__all__ + table_metrics.__all__
