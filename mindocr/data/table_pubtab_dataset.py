...
class PubTabDataset(BaseDataset):
    def __init__(
        ...
        **kwargs: Any
        ...
        # print(self.data_list[:50])  # TODO: see the data structure, delete it before push
            ...
            with open(file, "rb") as f:
                ...
                if self.is_train is True or sample_ratio_list[idx] < 1.0:
                    ...
                    lines = random.sample(lines,
                                          round(len(lines) * sample_ratio_list[idx]))
    ...
    def __getitem__(self, idx):
        ...
        if outs is None:
            ...
            )) if self.is_train is True else (idx + 1) % self.__len__()
